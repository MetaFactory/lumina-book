...
/**
 * REST controller for managing {@link com.metafactory.luminabook.domain.Booking}.
 */
@RestController
...
public class BookingResource {
    ...
    public ResponseEntity<Booking> partialUpdateBooking(
        ...
        Optional<Booking> result = bookingRepository
            ...
            .map(existingBooking -> {
                updateIfPresent(existingBooking::setGuestEmail, booking.getGuestEmail());
                updateIfPresent(existingBooking::setGuestName, booking.getGuestName());
                updateIfPresent(existingBooking::setStartTime, booking.getStartTime());
                updateIfPresent(existingBooking::setEndTime, booking.getEndTime());
                updateIfPresent(existingBooking::setStatus, booking.getStatus());
                updateIfPresent(existingBooking::setNotes, booking.getNotes());
     ...
     */
    @GetMapping("")
    public List<Booking> getAllBookings(@RequestParam(name = "eagerload", required = false, defaultValue = "true") boolean eagerload) {
