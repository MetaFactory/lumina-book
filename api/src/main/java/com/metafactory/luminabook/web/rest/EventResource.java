...
/**
 * REST controller for managing {@link com.metafactory.luminabook.domain.Event}.
 */
@RestController
...
public class EventResource {
    ...
    public ResponseEntity<Event> partialUpdateEvent(
        ...
        Optional<Event> result = eventRepository
            ...
            .map(existingEvent -> {
                updateIfPresent(existingEvent::setTitle, event.getTitle());
                updateIfPresent(existingEvent::setDescription, event.getDescription());
                updateIfPresent(existingEvent::setStartTime, event.getStartTime());
                updateIfPresent(existingEvent::setEndTime, event.getEndTime());
                updateIfPresent(existingEvent::setLocation, event.getLocation());
                updateIfPresent(existingEvent::setStatus, event.getStatus());
