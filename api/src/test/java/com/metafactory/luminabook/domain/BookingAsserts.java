...
public class BookingAsserts {
    ...
    public static void assertBookingUpdatableFieldsEquals(Booking expected, Booking actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getGuestEmail()).as("check guestEmail").isEqualTo(expected.getGuestEmail()))
            .satisfies(a -> assertThat(a.getGuestName()).as("check guestName").isEqualTo(expected.getGuestName()))
    ...
    public static void assertBookingUpdatableRelationshipsEquals(Booking expected, Booking actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getBookingPage()).as("check bookingPage").isEqualTo(expected.getBookingPage()));
    }
}
